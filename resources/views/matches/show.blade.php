                    ...
                    <div class="row w-100 mb-8 mb-md-10">
                        <div class="col-12">
                            <div class="top_matches__title d-flex align-items-center gap-2 mb-4">
                                <img src="{{url('assets/images/icon/king.png')}}" alt="Icon">
                                <h3>

                                @if(request()->id=='ds')  
                                Daily sure tips
                                @elseif(request()->id=='ft')
                                Football tips
                                @elseif(request()->id=='ou')
                                Over under
                                @elseif(request()->id=='st')
                                Single tips
                                @elseif(request()->id=='dt')
                                Daily 20 + odds
                                @elseif(request()->id=='bs')
                                Bonus Suprise
                                @elseif(request()->id=='cs')
                                Correct score
                                @elseif(request()->id=='htft')
                                Half time / Full time
                                                            ...
                                                            <div class="top_matches__clubname">
                                                                <div
                                                                    ...
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        <img src="{{url('assets/images/icon/floorball.png')}}"
                                                                            alt="Icon"> <span
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="d-flex align-items-center gap-1">
                                                                            <img src="{{url('assets/images/icon/updwon.png')}}"
                                                                                alt="Icon">
                                                                            <img src="{{url('assets/images/icon/t-shart.png')}}"
                                                                                alt="Icon">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="d-flex flex-column gap-5">
                                                                            <img class="cpoint"
                                                                                src="{{url('assets/images/icon/line-chart.png')}}"
                                                                                alt="Icon">
                                                                            <img class="cpoint"
                                                                                src="{{url('assets/images/icon/star.png')}}"
                                                                                alt="Icon">
                                                                        </div>
                                                                    </div>
                                                                </div>
